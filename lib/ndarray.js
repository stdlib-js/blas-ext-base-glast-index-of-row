...
* var workspace = [ 0, 0, 0 ];
*
* var out = glastIndexOfRow( 3, 2, A, 2, 1, 0, x, 1, 0, workspace, 1, 0 );
* // returns 2
*
* @example
...
* var workspace = [ 0, 0, 0 ];
*
* var out = glastIndexOfRow( 3, 2, A, 1, 3, 0, x, 1, 0, workspace, 1, 0 );
* // returns 2
*
* @example
...
* // returns -1
*/
function glastIndexOfRow( M, N, A, strideA1, strideA2, offsetA, x, strideX, offsetX, workspace, strideW, offsetW ) {
	var da0;
	var da1;
	var S0;
	var S1;
	...
	if ( oa.accessorProtocol || ox.accessorProtocol || ow.accessorProtocol ) {
		return accessors( M, N, oa, strideA1, strideA2, offsetA, ox, strideX, offsetX, ow, strideW, offsetW );
	}
