...
tape( 'the function has an arity of 12', function test( t ) {
	t.strictEqual( glastIndexOfRow.length, 12, 'returns expected value' );
	t.end();
});
...
tape( 'the function returns an invalid index when M is less than or equal to zero (row-major)', function test( t ) {
	...
	data = ROW_MAJOR_DATA;
	out = glastIndexOfRow( 0, data.N, data.A, data.strideA1, data.strideA2, data.offsetA, data.x, data.strideX, data.offsetX, zeros( data.M ), 1, 0 );
...
tape( 'the function returns an invalid index when N is less than or equal to zero (row-major)', function test( t ) {
	...
	data = ROW_MAJOR_DATA;
	out = glastIndexOfRow( data.M, 0, data.A, data.strideA1, data.strideA2, data.offsetA, data.x, data.strideX, data.offsetX, zeros( data.M ), 1, 0 );
...
tape( 'the function returns the index of the last row matching a search vector (row-major)', function test( t ) {
	...
	data = ROW_MAJOR_DATA;
	out = glastIndexOfRow( data.M, data.N, data.A, data.strideA1, data.strideA2, data.offsetA, data.x, data.strideX, data.offsetX, zeros( data.M ), 1, 0 );
...
tape( 'the function returns the index of the last row matching a search vector (row-major, accessors)', function test( t ) {
	...
	data = ROW_MAJOR_DATA;
	out = glastIndexOfRow( data.M, data.N, toAccessorArray( data.A ), data.strideA1, data.strideA2, data.offsetA, toAccessorArray( data.x ), data.strideX, data.offsetX, toAccessorArray( zeros( data.M ) ), 1, 0 );
...
tape( 'the function returns the index of the last row matching a search vector (row-major, offsets, accessors)', function test( t ) {
	var data;
	var out;
...
tape( 'the function returns the index of the last row matching a search vector (column-major, offsets, accessors)', function test( t ) {
	var data;
	var out;
...
tape( 'the function returns the index of the last row matching a search vector (row-major, mixed strides, accessors)', function test( t ) {
	var data;
	var out;
...
tape( 'the function returns the index of the last row matching a search vector (column-major, mixed strides, accessors)', function test( t ) {
	var data;
	var out;
...
tape( 'the function returns the index of the last row matching a search vector (row-major, negative strides, accessors)', function test( t ) {
	var data;
	var out;
...
tape( 'the function returns the index of the last row matching a search vector (column-major, negative strides, accessors)', function test( t ) {
	var data;
	var out;
...
tape( 'the function returns the index of the last row matching a search vector (row-major, large strides, accessors)', function test( t ) {
	var data;
	var out;
...
tape( 'the function returns the index of the last row matching a search vector (column-major, large strides, accessors)', function test( t ) {
	var data;
	var out;
